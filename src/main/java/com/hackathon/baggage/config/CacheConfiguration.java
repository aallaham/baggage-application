package com.hackathon.baggage.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.hackathon.baggage.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.hackathon.baggage.repository.UserRepository.USERS_BY_EMAIL_CACHE);
